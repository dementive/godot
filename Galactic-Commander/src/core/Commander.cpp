...
Vector<ShipID> Commander::get_ships() { return ships; }
...
Vector<StellarBodyID> Commander::get_owned_stellar_bodies() { return owned_stellar_bodies; }

void Commander::add_owned_stellar_body(StellarBodyID body) {}

HashMap<String, GC::Resource *> Commander::get_resources() { return resources; }

void Commander::set_resource(String resource_name) {}

HashMap<CommanderID, DiplomaticRelation> Commander::get_diplomatic_relations() { return diplomatic_relations; }

void Commander::set_diplomatic_relation(Commander *target, DiplomaticRelation new_relation) {}

Vector<TradeRoute> Commander::get_trade_routes() { return trade_routes; }
