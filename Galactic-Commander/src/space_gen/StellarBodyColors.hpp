...
public:
	...
	*/
	...
	static Array get_lava_planet_colors() {
		...
		array.append_array(get_color_array(get_color(1, 0.52, 0.2), get_color(0.89, 0.28, 0.25), get_color(0.68, 0.18, 0.27), get_color(0.32, 0.2, 0.25),
	...
	static Array get_sand_planet_colors() {
		Array array = Array();
		PackedColorArray regular_sand = get_color_array(get_color_html("f2be6e"), get_color_html("c16d34"), get_color_html("4d3119"), get_color_html("efd6c6"),
		...
		array.append_array(get_color_array(get_color(0.98, 0.88, 0.73), get_color(0.81, 0.65, 0.53), get_color(0.57, 0.38, 0.22), get_color(0.47, 0.32, 0.21),
				get_color(0.33, 0.27, 0.22), get_color(0.55, 0.39, 0.23), get_color(0.88, 0.68, 0.51)));
	...
	static Array get_gas_planet_colors() {
		Array array = Array();
		array.append_array(get_color_array(get_color(0.78, 0.55, 0.23), get_color(0.56, 0.38, 0.30), get_color(0.83, 0.61, 0.49), get_color(0.65, 0.61, 0.53),
				get_color(0.25, 0.27, 0.21), get_color(0.4, 0.26, 0.2), get_color(0.76, 0.56, 0.47)));
	...
	static Array get_ice_planet_colors() {
		Array array = Array();
		array.append_array(get_color_array(get_color(0.31, 0.61, 0.78), get_color(0.47, 0.68, 0.81), get_color(0.62, 0.75, 0.83), get_color(0.93, 0.94, 0.97),
				get_color(0.82, 0.85, 0.89), get_color(0.11, 0.29, 0.38), get_color(0.63, 0.82, 0.94)));
	...
	static Array get_no_atmosphere_colors() {
		Array array = Array();
		array.append_array(get_color_array(get_color(0.19, 0.18, 0.18), get_color(0.58, 0.56, 0.55), get_color(0.85, 0.85, 0.84), get_color(0.94, 0.94, 0.94),
	...
	static Dictionary get_star_colors() {
		...
		star_colors["blue"] = get_color_array(get_color(0.2, 0.2, 0.8), get_color(0.1, 0.1, 0.9), get_color(0.3, 0.3, 0.7), get_color(0.15, 0.15, 0.85),
